...
but not works with duplicate exists.
...
The method about binary search return most left or right target element index can be found in method 704-binary-search.py.
"""
